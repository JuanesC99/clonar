            ...
            <div className="row align-items-end">
                <div className="col-lg-8">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <span className="mil-suptitle mil-light mil-upper mil-up mil-mb-30">Politicas</span>
                            <p className="mil-text-sm mil-up mil-light-soft mil-mb-30">
                                <Link href='/policies/private-policy'>Privasidad de datos</Link>
                                <br />
                                <Link href='/policies/terms-of-use'>Terminos de uso</Link> 
                            </p>
                        </div>
                        <div className="col-md-6 col-lg-6 col-xl-3">
